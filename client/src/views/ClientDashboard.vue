      ...
      <div class="max-w-[900px] mx-auto">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-[15px] text-[#6B6B6B]">
            Manage your bookings and discover amazing creators
          </p>
        </div>
        ...
        <div class="bg-white border-[1.5px] border-[#E8E8E8] rounded-[14px] p-8 text-center">
          ...
          <p class="text-[15px] text-[#6B6B6B] mb-6">
            We're building an amazing dashboard experience for you. Meanwhile, you can browse and book talented creators.
          </p>
