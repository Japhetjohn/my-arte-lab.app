...
const baseClasses = 'w-full px-4 py-2.5 text-base rounded-lg border-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed bg-white hover:border-neutral-400'

const stateClasses = computed(() => {
  if (props.error) {
    return 'border-error text-error focus:border-error focus:ring-error/30'
  }
  return 'border-neutral-200 text-neutral-900 focus:border-primary focus:ring-primary/20 placeholder-neutral-400'
})
