    ...
    mainContent.innerHTML = `
        ...
        <style>
            ...
            .wallet-action-btn {
                ...
                padding: 14px 10px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12);
                border-radius: 14px; cursor: pointer; transition: all 0.2s; color: white; font-size: 12px; font-weight: 600;
            }
            .wallet-action-btn:hover { background: rgba(255,255,255,0.15); transform: translateY(-1px); }
